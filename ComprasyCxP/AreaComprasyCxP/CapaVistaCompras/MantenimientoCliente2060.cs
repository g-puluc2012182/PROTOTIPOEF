...
{
    public partial class MantenimientoCliente2060 : Form
    {
        public MantenimientoCliente2060()
        {
            InitializeComponent();
            ...
            navegador1.idAplicacion = "2060";
            navegador1.tablaAyuda = "aplicacion";
            navegador1.campoAyuda = "pkId";
            navegador1.pideGrid(dataGridView1);
            navegador1.llenaTabla();
            navegador1.pedirRef(this);
            navegador1.funLlenarComboControl(cboTipo, "tipoCliente", "idTipo", "nombre", "estatus");
        }
        ...
        public void funActualizarUsuario(string user)
        {
            ...
            navegador1.aplicacion = "MantenimientoCliente2060";
        ...
        private void MantenimientoCliente2060_Load(object sender, EventArgs e)
        {
